...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_WeaponSpecial_Light, "Player.Cooldown.WeaponSpecial.Light");
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_WeaponSpecial_Heavy, "Player.Cooldown.WeaponSpecial.Heavy");

...
{
	checkf(!CharacterCarriedWeaponMap.Contains(InWeaponTagToRegister), TEXT("A tag titled %s has already been added as a carried weapon"), *InWeaponTagToRegister.ToString());
